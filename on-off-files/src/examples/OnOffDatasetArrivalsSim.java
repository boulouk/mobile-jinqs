...
class OnOffDatasetArrivalsSim extends Sim {
	...
	public OnOffDatasetArrivalsSim(double d) {
		...
		Network.initialise();
		serviceTime = new Exp(1);

		Exp onlineTime = new Exp(0.025);
		Exp offlineTime = new Exp(0.025);

		Delay serveTime = new Delay(serviceTime);
		
		
		FileDataSet antenna1 = new FileDataSet("SET2_AntennaFull_24.txt");
...
//		Network.logResult("CompletionsOFF", Network.completionsOFF);
	...
	public static void main(String args[]) {
		new OnOffDatasetArrivalsSim(2.8431E7);
//		new OnOffDatasetArrivalsSim(2.85858E7);
//		new OnOffDatasetArrivalsSim(2.85516E7);
