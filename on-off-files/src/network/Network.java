...
public class Network {
	...
	public static int completionsDelivered = 0;
	...
	public static CustomerMeasure responseTimeDelivered = new CustomerMeasure();
	...
	public static void initialise() {
		...
		responseTimeExpired = new CustomerMeasure();
		responseTimeDelivered = new CustomerMeasure();
	...
	public static int add(Node n) {
		Check.check(initialised, "Class Network has not been initialised.\n"
	...
	public static void registerCompletionDelivered(double t) {
		responseTimeDelivered.add(t);
	}
...
//		Logger.logResult("Completed customers Expired", Network.completionsExpired);
//		Logger.logResult("Completed customers Delivered", Network.completionsDelivered);
...
//		Logger.logResult("Mean time in network Expired", responseTimeExpired.mean());
//		Logger.logResult("Mean time in network Delivered", responseTimeDelivered.mean());
