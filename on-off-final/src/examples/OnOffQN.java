...
public class OnOffQN extends QueueingNode {
	...
	public OnOffQN(String s, Delay d, int n, DistributionSampler on,
			DistributionSampler off, double dur) {
		super(s, d, n);
		con = true;
...
//					this.setDurationCustomersEndOn(dur + c.getMiddleServiceDemand1() + c.getMiddleServiceDemand2());
...
//			System.out.println("after on: " + c.getId() + "time: " + Sim.now() + " queue " + this.getName() + " middle: " + c.isMiddleCustomer());
